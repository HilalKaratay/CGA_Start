package cga.exercise.movementController

import cga.exercise.components.entitaet.Entity
import org.joml.Random
open class Movement(entity: Entity): MovementController.MovementController(entity) {

...
class CubemapTexture(var vertices: FloatArray, var indices: IntArray): Transformable() {
    ...
    fun loadCubeMap(faces: ArrayList<String>) : Int {
        ...
        GL30.glBindBuffer(GL30.GL_ELEMENT_ARRAY_BUFFER, skyboxIBO)
        ...
        GL30.glBindTexture(GL30.GL_TEXTURE_CUBE_MAP, cubeMaptexID)
        ...
        GL30.glEnable(AMDSeamlessCubemapPerTexture.GL_TEXTURE_CUBE_MAP_SEAMLESS)
